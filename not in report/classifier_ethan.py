...
train = np.array(datain['dataset']['Train']['train'])


train_dataset = pd.DataFrame(train)
train_dataset.columns = ['Max X', 'Max Y', 'Max Z', 'Max Abs', 'Min X', 'Min Y', 'Min Z', 'Min Abs',
                         'Mean X', 'Mean Y', 'Mean Z', 'Mean Abs', 'Skew X', 'Skew Y', 'Skew Z', 'Skew Abs',
                         'STD X', 'STD Y', 'STD Z', 'STD Abs', 'Kurt X', 'Kurt Y', 'Kurt Z', 'Kurt Abs', 'Label']

# Import testing data
test = np.array(datain['dataset']['Test']['test'])

test_dataset = pd.DataFrame(test)
test_dataset.columns = ['Max X', 'Max Y', 'Max Z', 'Max Abs', 'Min X', 'Min Y', 'Min Z', 'Min Abs',
